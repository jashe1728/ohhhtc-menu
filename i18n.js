...
en: {
  ...
  items: {
    ...
    9:  { desc: 'Crispy, served with citrus mayonnaise. For a main dish, request sides (fries, rice, etc.)' },
    ...
    33: { desc: 'House wine — also on tap' },
     34: { desc: 'House wine — 1L jug, also on tap' },
...
fr: {
  ...
  items: {
    ...
    9:  { desc: 'Croustillant, servi avec une mayonnaise citronnée. Pour un plat, demandez des accompagnements (frites, riz, etc.)' },
    ...
    22: { desc: 'Seiches fraîches grillées (à l\'encre ou sans)' },
    ...
    108: { desc: 'Espadon grillé au feu de bois' },
    ...
    33: { desc: 'Vin de la maison — aussi au fût' },
     34: { desc: 'Vin de la maison — pichet 1L, aussi au fût' },
...
es: {
  ...
  items: {
    ...
    9:  { desc: 'Crujiente, servido con mayonesa cítrica. Para un plato principal, pida acompañamientos (patatas fritas, arroz, etc.)' },
    ...
    33: { desc: 'Vino de la casa — también a presión' },
     34: { desc: 'Vino de la casa — jarra 1L, también a presión' },
...
it: {
  ...
  items: {
    ...
    9:  { desc: 'Crocante, servito con maionese agli agrumi. Per un piatto, richiedere contorni (patatine, riso, ecc.)' },
    ...
    33: { desc: 'Vino della casa — anche alla spina' },
     34: { desc: 'Vino della casa — caraffa 1L, anche alla spina' },
...
de: {
  ...
  items: {
    ...
    9:  { desc: 'Knusprig, mit Zitrusmayonnaise serviert. Als Hauptgericht auf Wunsch mit Beilagen (Pommes, Reis, etc.)' },
    ...
    22: { desc: 'Frische Sepia vom Grill (mit oder ohne Tinte)' },
    ...
    108: { desc: 'Schwertfisch vom Holzkohlengrill' },
    ...
    33: { desc: 'Hauswein — auch vom Fass' },
     34: { desc: 'Hauswein — Karaffe 1L, auch vom Fass' },
...
zh: {
  ...
  items: {
    ...
    7:  { desc: '以大蒜、橄榄油和辣椒翻炒' },
    8:  { desc: '香炒牛里脊配腌红洋葱' },
    9:  { desc: '外酥内嫩，佐柑橘蛋黄酱。如需作为主菜，请加配菜（薯条、米饭等）' },
    10: { desc: '经典暖心，风味十足' },
    ...
    33: { desc: '本店葡萄酒 — 也可按杯供应' },
     34: { desc: '本店葡萄酒 — 1升壶装，也可按杯供应' },
     37: { desc: '手工桑格利亚（白或红）' },
...
uk: {
  ...
  items: {
    ...
    9:  { desc: 'Хрустке, подається з цитрусовим майонезом. Для повної страви замовте гарніри (картопля фрі, рис тощо)' },
    ...
    33: { desc: 'Домашнє вино — також на розлив' },
     34: { desc: 'Домашнє вино — глечик 1 л, також на розлив' },
